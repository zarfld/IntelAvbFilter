...
if exist "tools\build" (
    ...
    powershell -NoProfile -ExecutionPolicy Bypass -File "tools/vs_compile.ps1" -BuildCmd "cl /nologo /W4 /Zi /I include /I external/intel_avb/lib /I . tests/integration/avb/avb_test_um.c /Fe:avb_test_i226.exe"
) else (
