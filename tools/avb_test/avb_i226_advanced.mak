...
!IF "$(CFG)" == "Debug"
CFLAGS = /nologo /W4 /Zi /EHsc /DUNICODE /D_UNICODE /DWIN32_LEAN_AND_MEAN /DAVB_I226_ADVANCED_USERMODE /I../../
LINKFLAGS = /nologo /DEBUG
!ELSE
CFLAGS = /nologo /W4 /O2 /EHsc /DUNICODE /D_UNICODE /DWIN32_LEAN_AND_MEAN /DAVB_I226_ADVANCED_USERMODE /I../../
LINKFLAGS = /nologo
!ENDIF
