...
# ===========================
# Reads IOCTL_AVB_GET_STATISTICS (0x9C40A020) directly via DeviceIoControl.
# Returns a hashtable of key lifecycle fields, or $null if the device is not accessible.
