...
| #204 | TEST-PTP-TARGET-001: Target Time Interrupt Verification (IOCTL 43, 15 TCs) | `tests/ioctl/test_ioctl_target_time.c` | **15P/0F/1S 2026-03-29** — TC-TARGET-001..015 cover UT-TARGET-001..010 + IT-TARGET-001..003. UT-TARGET-004 (past-time detection) verified by TC-TARGET-005: `2ad239e` rejects `target_time < current_systim` with `STATUS_INVALID_PARAMETER` (Win32 error 87). TC-TARGET-EVENT-001 SKIP (ring-buffer MapViewOfFile not implemented). Log: `test_ioctl_target_time.exe_20260329_*.log`. Traces #7. |
...
|-------|---------|-----------------|-----------------|
| #209 | TEST-LAUNCH-TIME-001: Launch Time Offload | *(none)* | ⚠️ **RE-OPENED 2026-03-30** — Attribution error corrected. Close on 2026-03-29 referenced `IOCTL_AVB_SET_TARGET_TIME` / TC-TARGET-005 / `2ad239e` — that work belongs to **#204** (TEST-PTP-TARGET-001: Target Time Interrupt). #209 requires `IOCTL_AVB_SET_LAUNCH_TIME` + `TQAVLAUNCHTIME` for per-packet TX scheduling (IEEE 802.1Qbv) — not yet implemented. No test file exists. UT-LAUNCH-001..010 / IT-LAUNCH-001..003 / VV-LAUNCH-001..002 all unwritten. Status: backlog. |
...
tests/ioctl/
  ...
  test_ioctl_target_time.c      → #204 target time interrupt + #299 aux timestamp ✅ 15P/0F/1S 2026-03-29 (attribution corrected 2026-03-30)
