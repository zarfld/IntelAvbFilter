...
//
EXTERN_C __declspec(selectany) DECLSPEC_CACHEALIGN ULONG IntelAvbFilterEnableBits[1];
EXTERN_C __declspec(selectany) const ULONGLONG IntelAvbFilterKeywords[4] = {0x8000000000000000, 0x8000000000000000, 0x8000000000000000, 0x8000000000000000};
EXTERN_C __declspec(selectany) const unsigned char IntelAvbFilterLevels[4] = {4, 2, 3, 1};

//
// Provider context
//
EXTERN_C __declspec(selectany) MCGEN_TRACE_CONTEXT INTELAVBFILTER_PROVIDER_Context = {0, (ULONG_PTR)INTELAVBFILTER_PROVIDER_Traits, 0, 0, 0, 0, 0, 0, 4, IntelAvbFilterEnableBits, IntelAvbFilterKeywords, IntelAvbFilterLevels};

//
// Provider REGHANDLE
//
#define IntelAvbFilterHandle (INTELAVBFILTER_PROVIDER_Context.RegistrationHandle)
...
//
#define INTELAVBFILTER_PROVIDER_EventWriteActivity 1
...
//
#ifndef EventRegisterIntelAvbFilter
#define EventRegisterIntelAvbFilter() McGenEventRegister(&INTELAVBFILTER_PROVIDER, McGenControlCallbackV2, &INTELAVBFILTER_PROVIDER_Context, &IntelAvbFilterHandle)
#endif
...
//
#ifndef EventRegisterByGuidIntelAvbFilter
#define EventRegisterByGuidIntelAvbFilter(Guid) McGenEventRegister(&(Guid), McGenControlCallbackV2, &INTELAVBFILTER_PROVIDER_Context, &IntelAvbFilterHandle)
#endif
...
//
#ifndef EventUnregisterIntelAvbFilter
#define EventUnregisterIntelAvbFilter() McGenEventUnregister(&IntelAvbFilterHandle)
#endif
...
// - Caller allocates memory, e.g. pContext = malloc(sizeof(McGenContext_IntelAvbFilter));
// - Caller registers the provider, e.g. EventRegisterIntelAvbFilter_ForContext(pContext);
// - Caller writes events, e.g. EventWriteMyEvent_ForContext(pContext, ...);
// - Caller unregisters, e.g. EventUnregisterIntelAvbFilter_ForContext(pContext);
// - Caller frees memory, e.g. free(pContext);
//

typedef struct tagMcGenContext_IntelAvbFilter {
    // The fields of this structure are subject to change and should
    // not be accessed directly. To access the provider's REGHANDLE,
    // use IntelAvbFilterHandle_ForContext(pContext).
    MCGEN_TRACE_CONTEXT Context;
    ULONG EnableBits[1];
} McGenContext_IntelAvbFilter;

#define EventRegisterIntelAvbFilter_ForContext(pContext)             _mcgen_PASTE2(_mcgen_RegisterForContext_IntelAvbFilter_, MCGEN_EVENTREGISTER)(&INTELAVBFILTER_PROVIDER, pContext)
#define EventRegisterByGuidIntelAvbFilter_ForContext(Guid, pContext) _mcgen_PASTE2(_mcgen_RegisterForContext_IntelAvbFilter_, MCGEN_EVENTREGISTER)(&(Guid), pContext)
#define EventUnregisterIntelAvbFilter_ForContext(pContext)           McGenEventUnregister(&(pContext)->Context.RegistrationHandle)

//
// Provider REGHANDLE for caller-allocated context.
//
#define IntelAvbFilterHandle_ForContext(pContext) ((pContext)->Context.RegistrationHandle)

// This function is for use by MC-generated code and should not be used directly.
// Initialize and register the caller-allocated context.
__inline
ULONG __stdcall
_mcgen_PASTE2(_mcgen_RegisterForContext_IntelAvbFilter_, MCGEN_EVENTREGISTER)(
    _In_ LPCGUID pProviderId,
    _Out_ McGenContext_IntelAvbFilter* pContext)
{
    RtlZeroMemory(pContext, sizeof(*pContext));
    pContext->Context.Logger = (ULONG_PTR)INTELAVBFILTER_PROVIDER_Traits;
    pContext->Context.EnableBitsCount = 4;
    pContext->Context.EnableBitMask = pContext->EnableBits;
    pContext->Context.EnableKeyWords = IntelAvbFilterKeywords;
    pContext->Context.EnableLevel = IntelAvbFilterLevels;
...
FORCEINLINE
_Ret_ McGenContext_IntelAvbFilter*
_mcgen_CheckContextType_IntelAvbFilter(_In_ McGenContext_IntelAvbFilter* pContext)
{
    return pContext;
}
...
//
// Enablement check macro for event "EVT_DRIVER_INIT"
//
#define EventEnabledEVT_DRIVER_INIT() _mcgen_EVENT_BIT_SET(IntelAvbFilterEnableBits, 0)
#define EventEnabledEVT_DRIVER_INIT_ForContext(pContext) _mcgen_EVENT_BIT_SET(_mcgen_CheckContextType_IntelAvbFilter(pContext)->EnableBits, 0)

//
// Event write macros for event "EVT_DRIVER_INIT"
//
#define EventWriteEVT_DRIVER_INIT(Activity) \
        MCGEN_EVENT_ENABLED(EVT_DRIVER_INIT) \
        ? _mcgen_TEMPLATE_FOR_EVT_DRIVER_INIT(&INTELAVBFILTER_PROVIDER_Context, &EVT_DRIVER_INIT, Activity) : 0
#define EventWriteEVT_DRIVER_INIT_AssumeEnabled() \
        _mcgen_TEMPLATE_FOR_EVT_DRIVER_INIT(&INTELAVBFILTER_PROVIDER_Context, &EVT_DRIVER_INIT, NULL)
#define EventWriteEVT_DRIVER_INIT_ForContext(pContext, Activity) \
        MCGEN_EVENT_ENABLED_FORCONTEXT(pContext, EVT_DRIVER_INIT) \
        ? _mcgen_TEMPLATE_FOR_EVT_DRIVER_INIT(&(pContext)->Context, &EVT_DRIVER_INIT, Activity) : 0
#define EventWriteEVT_DRIVER_INIT_ForContextAssumeEnabled(pContext) \
        _mcgen_TEMPLATE_FOR_EVT_DRIVER_INIT(&_mcgen_CheckContextType_IntelAvbFilter(pContext)->Context, &EVT_DRIVER_INIT, NULL)

// This macro is for use by MC-generated code and should not be used directly.
#define _mcgen_TEMPLATE_FOR_EVT_DRIVER_INIT _mcgen_PASTE2(McTemplateK0_, MCGEN_EVENTWRITETRANSFER)

//
// Enablement check macro for event "EVT_IOCTL_ERROR"
//
#define EventEnabledEVT_IOCTL_ERROR() _mcgen_EVENT_BIT_SET(IntelAvbFilterEnableBits, 1)
#define EventEnabledEVT_IOCTL_ERROR_ForContext(pContext) _mcgen_EVENT_BIT_SET(_mcgen_CheckContextType_IntelAvbFilter(pContext)->EnableBits, 1)

//
// Event write macros for event "EVT_IOCTL_ERROR"
//
#define EventWriteEVT_IOCTL_ERROR(Activity) \
        MCGEN_EVENT_ENABLED(EVT_IOCTL_ERROR) \
        ? _mcgen_TEMPLATE_FOR_EVT_IOCTL_ERROR(&INTELAVBFILTER_PROVIDER_Context, &EVT_IOCTL_ERROR, Activity) : 0
#define EventWriteEVT_IOCTL_ERROR_AssumeEnabled() \
        _mcgen_TEMPLATE_FOR_EVT_IOCTL_ERROR(&INTELAVBFILTER_PROVIDER_Context, &EVT_IOCTL_ERROR, NULL)
#define EventWriteEVT_IOCTL_ERROR_ForContext(pContext, Activity) \
        MCGEN_EVENT_ENABLED_FORCONTEXT(pContext, EVT_IOCTL_ERROR) \
        ? _mcgen_TEMPLATE_FOR_EVT_IOCTL_ERROR(&(pContext)->Context, &EVT_IOCTL_ERROR, Activity) : 0
#define EventWriteEVT_IOCTL_ERROR_ForContextAssumeEnabled(pContext) \
        _mcgen_TEMPLATE_FOR_EVT_IOCTL_ERROR(&_mcgen_CheckContextType_IntelAvbFilter(pContext)->Context, &EVT_IOCTL_ERROR, NULL)

// This macro is for use by MC-generated code and should not be used directly.
#define _mcgen_TEMPLATE_FOR_EVT_IOCTL_ERROR _mcgen_PASTE2(McTemplateK0_, MCGEN_EVENTWRITETRANSFER)

//
// Enablement check macro for event "EVT_PHC_FORCESET_WARN"
//
#define EventEnabledEVT_PHC_FORCESET_WARN() _mcgen_EVENT_BIT_SET(IntelAvbFilterEnableBits, 2)
#define EventEnabledEVT_PHC_FORCESET_WARN_ForContext(pContext) _mcgen_EVENT_BIT_SET(_mcgen_CheckContextType_IntelAvbFilter(pContext)->EnableBits, 2)

//
// Event write macros for event "EVT_PHC_FORCESET_WARN"
//
#define EventWriteEVT_PHC_FORCESET_WARN(Activity) \
        MCGEN_EVENT_ENABLED(EVT_PHC_FORCESET_WARN) \
        ? _mcgen_TEMPLATE_FOR_EVT_PHC_FORCESET_WARN(&INTELAVBFILTER_PROVIDER_Context, &EVT_PHC_FORCESET_WARN, Activity) : 0
#define EventWriteEVT_PHC_FORCESET_WARN_AssumeEnabled() \
        _mcgen_TEMPLATE_FOR_EVT_PHC_FORCESET_WARN(&INTELAVBFILTER_PROVIDER_Context, &EVT_PHC_FORCESET_WARN, NULL)
#define EventWriteEVT_PHC_FORCESET_WARN_ForContext(pContext, Activity) \
        MCGEN_EVENT_ENABLED_FORCONTEXT(pContext, EVT_PHC_FORCESET_WARN) \
        ? _mcgen_TEMPLATE_FOR_EVT_PHC_FORCESET_WARN(&(pContext)->Context, &EVT_PHC_FORCESET_WARN, Activity) : 0
#define EventWriteEVT_PHC_FORCESET_WARN_ForContextAssumeEnabled(pContext) \
        _mcgen_TEMPLATE_FOR_EVT_PHC_FORCESET_WARN(&_mcgen_CheckContextType_IntelAvbFilter(pContext)->Context, &EVT_PHC_FORCESET_WARN, NULL)

// This macro is for use by MC-generated code and should not be used directly.
#define _mcgen_TEMPLATE_FOR_EVT_PHC_FORCESET_WARN _mcgen_PASTE2(McTemplateK0_, MCGEN_EVENTWRITETRANSFER)

//
// Enablement check macro for event "EVT_HARDWARE_FAULT"
//
#define EventEnabledEVT_HARDWARE_FAULT() _mcgen_EVENT_BIT_SET(IntelAvbFilterEnableBits, 3)
#define EventEnabledEVT_HARDWARE_FAULT_ForContext(pContext) _mcgen_EVENT_BIT_SET(_mcgen_CheckContextType_IntelAvbFilter(pContext)->EnableBits, 3)

//
// Event write macros for event "EVT_HARDWARE_FAULT"
//
#define EventWriteEVT_HARDWARE_FAULT(Activity) \
        MCGEN_EVENT_ENABLED(EVT_HARDWARE_FAULT) \
        ? _mcgen_TEMPLATE_FOR_EVT_HARDWARE_FAULT(&INTELAVBFILTER_PROVIDER_Context, &EVT_HARDWARE_FAULT, Activity) : 0
#define EventWriteEVT_HARDWARE_FAULT_AssumeEnabled() \
        _mcgen_TEMPLATE_FOR_EVT_HARDWARE_FAULT(&INTELAVBFILTER_PROVIDER_Context, &EVT_HARDWARE_FAULT, NULL)
#define EventWriteEVT_HARDWARE_FAULT_ForContext(pContext, Activity) \
        MCGEN_EVENT_ENABLED_FORCONTEXT(pContext, EVT_HARDWARE_FAULT) \
        ? _mcgen_TEMPLATE_FOR_EVT_HARDWARE_FAULT(&(pContext)->Context, &EVT_HARDWARE_FAULT, Activity) : 0
#define EventWriteEVT_HARDWARE_FAULT_ForContextAssumeEnabled(pContext) \
        _mcgen_TEMPLATE_FOR_EVT_HARDWARE_FAULT(&_mcgen_CheckContextType_IntelAvbFilter(pContext)->Context, &EVT_HARDWARE_FAULT, NULL)

// This macro is for use by MC-generated code and should not be used directly.
#define _mcgen_TEMPLATE_FOR_EVT_HARDWARE_FAULT _mcgen_PASTE2(McTemplateK0_, MCGEN_EVENTWRITETRANSFER)
