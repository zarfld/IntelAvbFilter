...
// Build only via: nmake -f tests\\integration\\avb\\avb_test.mak (run from tests\\integration\\avb)

#ifdef _KERNEL_MODE
#error "tests/integration/avb/avb_test_um.c must not be compiled in kernel-mode driver project"
#endif
...
#include <string.h>
#include <stdlib.h>
/* Use correct relative paths to shared headers (three levels up from tests/integration/avb) */
#include "../../../include/avb_ioctl.h" /* shared IOCTL ABI */
#include "i210_regs.h"  /* SSOT register definitions (via -I flag) */
