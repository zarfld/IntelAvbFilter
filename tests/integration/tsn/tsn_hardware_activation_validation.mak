# nmake -f tsn_hardware_activation_validation.mak
...
$(OUTDIR)\tsn_hardware_activation_validation.obj: tsn_hardware_activation_validation.c
	$(CC) $(CFLAGS) /Fo$(OUTDIR)\ /c tsn_hardware_activation_validation.c

$(OUTDIR)\tsn_hardware_activation_validation.exe: $(OBJS)
	$(LD) $(LDFLAGS) /OUT:$(OUTDIR)\tsn_hardware_activation_validation.exe $(OBJS) $(LIBS)

clean:
	@if exist "$(OUTDIR)\tsn_hardware_activation_validation.*" del /Q "$(OUTDIR)\tsn_hardware_activation_validation.*"
