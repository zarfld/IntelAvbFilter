...
CC=cl
LD=link
CFLAGS=/nologo /W4 /Zi /EHsc /DUNICODE /D_UNICODE /DWIN32_LEAN_AND_MEAN /DHARDWARE_INVESTIGATION_USERMODE /I..\..\include /I..\..\external\intel_avb\lib /I..\..\intel-ethernet-regs\gen /I.
...
$(OUTDIR)\hardware_investigation_tool.obj: hardware_investigation_tool.c
	$(CC) $(CFLAGS) /Fo$(OUTDIR)\ /c hardware_investigation_tool.c
